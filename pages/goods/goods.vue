  ...
  <view>
    ...
    <view class="footer">
      <view class="icons">
        ...
        <view class="box" @tap="keep">
          <view
            class="icon"
            :class="[isKeep ? 'shoucangsel' : 'shoucang']"
          ></view>
    ...
    >
      ...
      <view class="layer" @tap.stop="discard">
        ...
        <view class="btn"
          ><view class="button" @tap="hideService">完成</view></view
        >
      </view>
    </view>
    <!-- 规格-模态层弹窗 -->
    ...
    >
      ...
      <view class="layer" @tap.stop="discard">
        ...
        <view class="btn"
          ><view class="button" @tap="hideSpec">完成</view></view
        >
      </view>
    </view>
    <!-- 商品主图轮播 -->
    <view class="swiper-box">
      ...
      <view class="indicator"
        >{{ currentSwiper + 1 }}/{{ swiperList.length }}</view
      >
    </view>
    <!-- 标题 价格 -->
    ...
    <view class="info-box comments" id="comments">
      <view class="row">
        <view class="text">资源评价({{ goodsData.comment.number }})</view>
...
export default {
  data() {
    return {
      ...
      //商品描述html
      descriptionStr:
        '<div style="text-align:center;"><img width="100%" src="https://ae01.alicdn.com/kf/HTB1t0fUl_Zmx1VjSZFGq6yx2XXa5.jpg"/></div>',
    };
  },
  onLoad(option) {
    // #ifdef MP
  ...
  onPageScroll(e) {
    //锚点切换
    this.selectAnchor =
      e.scrollTop >= this.anchorlist[2].top
        ? 2
        : e.scrollTop >= this.anchorlist[1].top
        ? 1
        : 0;
    //导航栏渐变
    let tmpY = 375;
